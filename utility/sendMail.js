...
const verifyAccountMail = async(to, sub, data = {}) => {
    ...
    await transport.sendMail({
        from: ` "Account Varification"  <${process.env.EMAIL_HOST}> `,
        to: to,
        subject: sub,
        html: `
       <!DOCTYPE html>
